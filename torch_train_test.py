...
model, outGT1, outPRED1 = CheXpertTrainer.test(model, dataLoaderTest, nnClassCount, "/home/dsv/maul8511/deep_learning_project/m-epoch2-16102020-094301.pth.tar", class_names)
model, outGT3, outPRED3 = CheXpertTrainer.test(model, dataLoaderTest, nnClassCount, "/home/dsv/maul8511/deep_learning_project/m-epoch1-16102020-094301.pth.tar", class_names)
...
#k_model = pytorch_to_keras(model.module, input_var, [(3, None, None,)], verbose=True)  
...
#frozen_graph = freeze_session(sess, output_names=[out.op.name for out in k_model.outputs])
